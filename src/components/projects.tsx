...
function Projects({ projects }: ProjectsProps) {
  ...
  // Memoize the filter function with useCallback to avoid recreating it on each render
  const applyFilters = useCallback((data: Project[], filterValues: string) => {
...
const Card = ({ title, image, smallDescription }: Project) => {
