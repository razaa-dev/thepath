...
import { 
  SiPython, SiJavascript, SiCplusplus, SiPhp, SiKotlin, 
  SiSharp, SiOpenjdk, SiTypescript 
} from "react-icons/si";
    ...
    <main onMouseMove={manageMouseMove} className={styles.main}>
      ...
      <div className={styles.title}>
        ...
        <p>
          ...
          <span>Python <SiPython size={30} /></span>
          <span>JavaScript <SiJavascript size={30} /></span>
          <span>C++ <SiCplusplus size={30} /></span>
          <span>PHP <SiPhp size={30} /></span>
          <span>Kotlin <SiKotlin size={30} /></span>
          <span>C# <SiSharp size={30} /></span>
          <span>Java <SiOpenjdk size={30} /></span>
          <span>TypeScript <SiTypescript size={30} /></span>
        </p>
      </div>
    </main>
  );
