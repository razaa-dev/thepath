...
const Contact = ({ email, social_handle, about }: ContactProps) => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      await emailjs.send(
        "service_jw3ixer", // Service ID
        "template_pvb31fn", // Template ID
        formData, // Form data containing user input
        "hqzPdPF_Av3mntQYo" // Public Key
      );
      ...
      <footer className="flex items-center justify-between md:px-8 px-2 py-4 text-sm">
        ...
        <Transition>
          <p>
            developed by @
            <Link
              href={"https://www.linkedin.com/in/rachad-wadie-b0a2422a0/"}
